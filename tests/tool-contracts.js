const toolContracts = [
  ...
  { id: 'qr-scanner', route: '/qr-scanner/', heading: /QR & Barcode Scanner/i, risk: 'device-input', deepSpec: 'qr-scanner.spec.js', visual: true, manualCheck: 'Scan one real QR code with the device camera or file picker and confirm the decoded result.' },
