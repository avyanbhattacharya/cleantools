...
const astroManagedToolFiles = {
  ...
  'photo-to-scan': ['index.html'], 'qr-code-maker': ['index.html'], 'qr-scanner': ['index.html'], 'remove-photo-metadata': ['index.html'],
...
const directories = [
  ...
  'passport-photo', 'photo-to-scan', 'principles', 'qr-code-maker', 'qr-scanner', 'remove-photo-metadata',
